...
class Repo
{
    ...
    void viewResult()
    {
        ...
        cout<<"No results to be displayed\n";
        else
        for(int i=0;i<resultList.size();i++)
        {
            cout<<resultList[i].studentName<<" "<<resultList[i].TestId<<" "<<resultList[i].mark<<endl;
        }
...
class Teacher:public User{
    ...
    void addTest(Repo repo)
    {
        ...
        int ques;
        cin>>ques;
        cout<<"Enter Number of Easy cout:\n";
        int easy;
        cin>>easy;
        cout<<"Enter Number of Medium cout:\n";
        int med;
        cin>>med;
        cout<<"Enter Number of Hard cout:\n";
        int hard;
        cin>>hard;
...
class Admin: public User{
    ...
    void addQuestion(Repo &repo)
    {
        ...
        cin>>answer;
        Question que(id,question,options,difficulty,answer);
        repo.add(que);
